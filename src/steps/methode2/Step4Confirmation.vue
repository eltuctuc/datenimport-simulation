...
const selectedRecords = computed(() =>
  allRecords.value.filter(r => store.methode2.selectedRecordIds.includes(r.id))
)
</script>
  ...
  <div class="space-y-6">
    <Card>
      <CardHeader>
        ...
        <CardDescription>Bitte bestätigen Sie die Übernahme der ausgewählten Datensätze.</CardDescription>
      </CardHeader>
      <CardContent>
